# File: main.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/cli/main.py
...
from ClaudeMonitor.Cli.Bootstrap import (
    ensure_directories,
    init_timezone,
    setup_environment,
    setup_logging,
)
from ClaudeMonitor.Core.Plans import Plans, PlanType, get_token_limit
from ClaudeMonitor.Core.Settings import Settings
from ClaudeMonitor.Data.Aggregator import UsageAggregator
from ClaudeMonitor.Data.Analysis import analyze_usage
from ClaudeMonitor.ErrorHandling import report_error
from ClaudeMonitor.Monitoring.IntelligentOrchestrator import IntelligentOrchestrator as MonitoringOrchestrator
from ClaudeMonitor.Terminal.Manager import (
...
from ClaudeMonitor.Terminal.Themes import get_themed_console, print_themed
from ClaudeMonitor.Ui.DisplayController import DisplayController
from ClaudeMonitor.Ui.TableViews import TableViewsController
...
def handle_application_error(
    ...
    from ClaudeMonitor.ErrorHandling import report_application_startup_error
