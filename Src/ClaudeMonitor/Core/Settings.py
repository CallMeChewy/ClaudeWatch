# File: settings.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/core/settings.py
...
class Settings(BaseSettings):
    ...
    def _get_system_timezone() -> str:
        ...
        from ClaudeMonitor.Utils.TimeUtils import get_system_timezone
    ...
    def _get_system_time_format() -> str:
        """Lazy import to avoid circular dependencies."""
        from ClaudeMonitor.Utils.TimeUtils import get_system_time_format
    ...
    def load_with_last_used(cls, argv: Optional[List[str]] = None) -> "Settings":
        ...
        if settings.theme == "auto" or (
            ...
            from ClaudeMonitor.Terminal.Themes import (
                BackgroundDetector,
                BackgroundType,
            )
