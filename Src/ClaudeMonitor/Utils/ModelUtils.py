# File: model_utils.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/utils/model_utils.py
...
def normalize_model_name(model: str) -> str:
    ...
    """
    from ClaudeMonitor.Core.Models import normalize_model_name as _normalize_model_name
