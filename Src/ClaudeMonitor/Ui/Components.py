# File: components.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/ui/components.py
...
from ClaudeMonitor.Terminal.Themes import get_cost_style, get_velocity_indicator
...
class LoadingScreenComponent:
    ...
    def create_loading_screen_renderable(
        ...
        from ClaudeMonitor.Ui.DisplayController import ScreenBufferManager
...
class AdvancedCustomLimitDisplay:
    ...
    def _is_limit_session(self, session: Dict[str, Any]) -> bool:
        ...
        from ClaudeMonitor.Core.Plans import (
            COMMON_TOKEN_LIMITS,
