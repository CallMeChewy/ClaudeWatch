...
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/ui/progress_bars.py
...
from ClaudeMonitor.Utils.TimeUtils import percentage
...
class TimeProgressBar(BaseProgressBar):
    ...
    def render(self, elapsed_minutes: float, total_minutes: float) -> str:
        ...
        """
        from ClaudeMonitor.Utils.TimeUtils import format_time
