# File: session_display.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/ui/session_display.py
...
from ClaudeMonitor.Ui.Components import CostIndicator, VelocityIndicator
from ClaudeMonitor.Ui.Layouts import HeaderManager
from ClaudeMonitor.Ui.ProgressBars import (
    ModelUsageBar,
    TimeProgressBar,
    TokenProgressBar,
)
...
class SessionDisplayComponent:
    ...
    def _render_wide_progress_bar(self, percentage: float) -> str:
        ...
        """
        from ClaudeMonitor.Terminal.Themes import get_cost_style
    ...
    def format_active_session_screen(
        ...
        **kwargs,
        ...
        if plan in ["custom", "pro", "max5", "max20"]:
            from ClaudeMonitor.Core.Plans import DEFAULT_COST_LIMIT
