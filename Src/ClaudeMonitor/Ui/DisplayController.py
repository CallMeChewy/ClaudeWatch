# File: display_controller.py
# Path: /home/herb/Desktop/ClaudeWatch/Src/ClaudeMonitor/ui/display_controller.py
...
from ClaudeMonitor.Core.Calculations import calculate_hourly_burn_rate
from ClaudeMonitor.Core.Models import normalize_model_name
from ClaudeMonitor.Core.Plans import Plans
from ClaudeMonitor.Ui.Components import (
    AdvancedCustomLimitDisplay,
    ErrorDisplayComponent,
    LoadingScreenComponent,
)
from ClaudeMonitor.Ui.Layouts import ScreenManager
from ClaudeMonitor.Ui.SessionDisplay import SessionDisplayComponent
from ClaudeMonitor.Utils.Notifications import NotificationManager
from ClaudeMonitor.Utils.TimeUtils import (
    TimezoneHandler,
    format_display_time,
...
class DisplayController:
    ...
    def create_data_display(
        ...
        if args.plan == "custom":
            ...
            from ClaudeMonitor.Core.Plans import get_cost_limit
...
class ScreenBufferManager:
    ...
    def create_screen_renderable(self, screen_buffer: List[str]) -> Group:
        ...
        """
        from ClaudeMonitor.Terminal.Themes import get_themed_console
