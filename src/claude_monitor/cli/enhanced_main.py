...
# Path: /home/herb/Desktop/ClaudeWatch/src/claude_monitor/cli/enhanced_main.py
# Standard: AIDEV-PascalCase-2.1
# Created: 2025-01-26
# Last Modified: 2025-01-26 06:50PM
...
from claude_monitor.cli.bootstrap import setup_environment, setup_logging, ensure_directories
from claude_monitor.core.SettingsAnalyzer import SettingsAnalyzer
from claude_monitor.ui.StartupAnalysisDisplay import StartupAnalysisDisplay
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        if args.log_file:
            setup_logging(log_level, args.log_file, disable_console=False)
        else:
            setup_logging(log_level, disable_console=False)
