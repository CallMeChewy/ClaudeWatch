...
# Path: /home/herb/Desktop/ClaudeWatch/src/claude_monitor/data/enhanced_database.py
# Standard: AIDEV-PascalCase-2.1
# Created: 2025-01-26
# Last Modified: 2025-01-26 06:20PM
...
class EnhancedDatabaseManager:
    ...
    def __init__(self, db_path: Optional[Path] = None) -> None:
        ...
        if db_path is None:
            db_path = Path.home() / ".claude-monitor" / "enhanced_monitor.db"
